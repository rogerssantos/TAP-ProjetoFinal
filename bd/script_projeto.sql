...
CREATE TABLE tbprofessor (
    cdprofessor INTEGER       PRIMARY KEY AUTOINCREMENT
                            NOT NULL,
...
CREATE TABLE tbaluno (
    cdaluno INTEGER       PRIMARY KEY AUTOINCREMENT
                            NOT NULL,
    nmaluno VARCHAR (100) NOT NULL,
    idade INTEGER NOT NULL,
    dsserie VARCHAR(30) NOT NULL,
    dsturma VARCHAR(30) NOT NULL,
    flativo CHAR (1)      NOT NULL
);
...
CREATE TABLE tbopcaoresposta (
    cdopcaoresposta INTEGER       PRIMARY KEY AUTOINCREMENT
                            NOT NULL,
...
CREATE TABLE tbresposta (
    cdresposta INTEGER       PRIMARY KEY AUTOINCREMENT
                            NOT NULL,
